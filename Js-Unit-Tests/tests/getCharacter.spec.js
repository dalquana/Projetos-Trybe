...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  it('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    it('Verifica se a função quando não receber nehum parâmetro, retorne undefined',() => {
    ...
    it('Verifica se ao passar um nome que não está na tabela retorna undefined',() => {
      expect(getCharacter('deniries')).toBeUndefined()
    })
